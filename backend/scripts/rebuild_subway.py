...
LINES = [
    ...
    {"id": 21, "name": "2호선(신정지선)", "color": "#009D3E", "stations": [
        "신도림", "도림천", "양천구청", "신정네거리", "까치산",
    ]},
    {"id": 22, "name": "2호선(성수지선)", "color": "#009D3E", "stations": [
        "성수", "용답", "신답", "용두", "신설동",
    ]},
    ...
    {"id": 91, "name": "신림선", "color": "#6789CA", "stations": [
    ...
    {"id": 10, "name": "신분당선", "color": "#D31145", "stations": [
        "신사", "논현", "신논현", "강남", "양재", "양재시민의숲",
        "청계산입구", "판교", "정자", "미금", "동천", "수지구청",
        "성복", "상현", "광교중앙", "광교",
    ]},
    {"id": 11, "name": "우이신설선", "color": "#B0CE18", "stations": [
        "북한산우이", "솔밭공원", "4·19민주묘지", "가오리", "화계",
        "삼양", "삼양사거리", "솔샘", "북한산보국문", "정릉",
        "성신여대입구", "보문", "신설동",
    ]},
    {"id": 12, "name": "공항철도", "color": "#0090D2", "stations": [
        "서울역", "공덕", "홍대입구", "디지털미디어시티", "마곡나루",
        "김포공항", "계양", "검암", "인천공항1터미널", "인천공항2터미널",
    ]},
    {"id": 13, "name": "경의중앙선", "color": "#77C4A3", "stations": [
        "능곡", "행신", "수색", "디지털미디어시티", "가좌", "홍대입구",
        "서강대", "공덕", "효창공원앞", "용산", "이촌", "서빙고",
        "한남", "옥수", "응봉", "왕십리", "청량리", "회기",
        "중랑", "상봉", "망우", "양원", "구리",
    ]},
    {"id": 14, "name": "수인분당선", "color": "#FABE00", "stations": [
        "청량리", "왕십리", "서울숲", "압구정로데오", "강남구청",
        "선정릉", "한티", "도곡", "구룡", "개포동", "대모산입구",
        "수서", "복정", "가천대", "태평", "모란", "야탑", "이매",
        "서현", "수내", "정자", "미금",
    ]},
    {"id": 15, "name": "경춘선", "color": "#178C72", "stations": [
        "청량리", "회기", "광운대", "상봉", "망우", "신내",
        "갈매", "별내", "퇴계원", "사릉", "금곡",
    ]},
    {"id": 30, "name": "GTX-A", "color": "#9F4E97", "stations": [
        "운정", "킨텍스", "대곡", "연신내", "서울역", "수서",
        "성남", "용인", "동탄",
    ]},
]
